...
<section className="relative bg-hero overflow-hidden">
  ...
  <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24 overflow-hidden">

    {/* Top Label */}
    <div className="text-center">
      <span className="inline-block text-[11px] sm:text-xs font-semibold tracking-[0.18em] uppercase text-teal-200 mb-4">
        We're Here For You
      </span>

      {/* Heading */}
      <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-white leading-tight mb-5 max-w-4xl mx-auto">
        Contact{" "}
      ...
      {/* Description */}
      <p className="text-teal-100 text-base sm:text-lg max-w-2xl mx-auto leading-relaxed mb-8 sm:mb-10">
        Reach our team for appointments, second opinions,
        or emergency support — we respond promptly.
      </p>
    </div>
    ...
    <div className="flex flex-wrap justify-center gap-3 max-w-3xl mx-auto">
      {trustBadges.map((b) => (
        <div
          key={b.text}
          className="flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-3 py-2 sm:px-4 shrink-0"
        >
          <b.icon className="w-4 h-4 text-amber-300 flex-shrink-0" />
...
<div className="bg-teal-700 overflow-hidden">
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 divide-y sm:divide-y-0 sm:divide-x divide-teal-600">

      {contactCards.map((card) => (
        <div
          key={card.label}
          className="flex items-start gap-4 p-6 min-w-0"
        >
          {/* Icon */}
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="mb-2 min-w-0">
              <p className="text-teal-200 text-[11px] mb-0.5">
                {card.primaryLabel}
              </p>
              ...
              {card.primaryHref ? (
                <a
                  ...
                  className="block text-sm text-white font-medium hover:text-amber-300 transition-colors break-all"
                >
                  {card.primary}
                </a>
              ) : (
      ...
      <section className="pb-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-gray-100 h-[500px]">
           ...
           <div className="absolute bottom-3 left-3 right-3 sm:right-auto bg-white rounded-2xl px-4 py-3 shadow-lg flex items-center gap-3 max-w-[calc(100%-24px)]">
